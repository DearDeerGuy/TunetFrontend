...
function Header() {
    ...
    return (
        <div className={classes.Header}>
            <div className={[classes.headerLine,menu?classes.headerLineActive:''].join(' ')}>
                <div className={classes.headerLine_list}>
                    <NavLink onClick={()=>setMenu(false)} className={({ isActive }) => `${classes.link_button} ${isActive ? classes.link_buttonActive : ""}`} to="/main">Головна</NavLink>
            ...
            <div className={classes.headerBlock}>
                <div className={classes.logo_block}>
                    <Link className={classes.header_logo} to="/main" onClick={()=>setMenu(false)}>
                        <img className={classes.header_logo_img} src={logo} alt="" width={180}/> 
                    </Link>
                    {user.token&&<div className={[classes.link_block,classes.smallNone].join(' ')}>
                        <NavLink className={({ isActive }) => `${classes.link_button} ${isActive ? classes.link_buttonActive : ""}`} to="/gallery">Фільми</NavLink>
                        <NavLink className={({ isActive }) => `${classes.link_button} ${isActive ? classes.link_buttonActive : ""}`} to="/favorite">Обрані</NavLink>
                    </div>}
                </div>
